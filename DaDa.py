...
OPENSOURCE/waj.py
@KING-ID
KING-ID Add files via upload
 1 contributor
421 lines (406 sloc)  39.8 KB
import random
from os import path
...
def KING():
	...
	print(f" [0] Exit")
	KING = input("\033[;90m [>]\033[;37m Choose an option : ")
	if KING in ["2", "02"]:
		gml()
	if KING in ["3","03"]:
		bd()
	if KING in ["1", "01","11","A","a"]:
		clear()
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  KING, Haris, Bilal')
